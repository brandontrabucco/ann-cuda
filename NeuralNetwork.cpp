...
vector<double> NeuralNetwork::train(double input, double actual, bool print) {
...
vector<double> NeuralNetwork::train(vector<double> input, vector<double> actual, bool print) {
